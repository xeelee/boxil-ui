function CookiePolicy() {
  return (
    <div className="prose p-8 max-w-none">
      <h1>Cookie Policy for Boxil by Titil</h1>

      <p>This is the Cookie Policy for Boxil by Titil, accessible from https://boxil.titil.pl</p>
      ...
      <li>By visiting this link: https://boxil.titil.pl/cookie-policy</li>
      </ul>
    </div>
  );
}
